...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(nonnull NSArray<CLLocation *> *)locations {
    ...
    //保存手机当前的经纬度
    [CustomAccount sharedCustomAccount].UserLatitude =[NSString stringWithFormat:@"%f",loc.coordinate.latitude];
    [CustomAccount sharedCustomAccount].userLongitude =[NSString stringWithFormat:@"%f",loc.coordinate.longitude];
